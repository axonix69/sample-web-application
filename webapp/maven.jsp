...
<h2 id="introduction">Introduction<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon=""
                                     href="#introduction"
                                     style="font: 1em / 1 anchorjs-icons; padding-left: 0.375em;"></a></h2>

<p>Maven, a <a href="https://en.wikipedia.org/wiki/Maven" class="externalLink">Yiddish word</a> meaning
...
with the comprehension of any Java-based project.</p>
